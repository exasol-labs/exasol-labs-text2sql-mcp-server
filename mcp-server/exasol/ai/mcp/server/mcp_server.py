...
from exasol.ai.mcp.server.text_to_sql import start_t2s_process
from exasol.ai.mcp.server.text_to_sql import GraphState
...
class ExasolMCPServer(FastMCP):
    ...
    def _register_tools(self):
        ...
        if self.config.enable_text_to_sql:
            self.tool(
                self.text_to_sql,
                description=(
